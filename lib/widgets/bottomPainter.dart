...
import '../pages/Pofile/ViewProfile.dart';
import '../pages/myOrder/myOrderDetails.dart';
...
class RPSCustomPainter3 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.6886111,
        size.height * 0.1546392,
        size.width * 0.6563889,
        size.height * 0.3578792,
        size.width * 0.6252778,
        size.height * 0.5537555);
    path_0.cubicTo(
        size.width * 0.5944444,
        size.height * 0.7481591,
        size.width * 0.5625000,
        size.height * 0.9484536,
        size.width * 0.5000000,
        size.height * 0.9484536);
    path_0.cubicTo(
        size.width * 0.4375000,
        size.height * 0.9484536,
        size.width * 0.4055556,
        size.height * 0.7481591,
        size.width * 0.3747222,
        size.height * 0.5537555);
    path_0.cubicTo(
        size.width * 0.3436111,
        size.height * 0.3578792,
        size.width * 0.3113889,
        size.height * 0.1546392,
        size.width * 0.2480556,
        size.height * 0.1546392);
    ...
    path_0.cubicTo(
        ...
        size.height * 0.1664212,
        size.width * 0.3425000,
        size.height * 0.3681885,
        size.width * 0.3733333,
        size.height * 0.5611193);
    path_0.cubicTo(
        size.width * 0.4044444,
        size.height * 0.7569956,
        size.width * 0.4366667,
        size.height * 0.9602356,
        size.width * 0.5002778,
        size.height * 0.9602356);
    path_0.cubicTo(
        size.width * 0.5638889,
        size.height * 0.9602356,
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.arcToPoint(Offset(size.width * 0.5875000, size.height * 0.1417205),
        radius: Radius.elliptical(
            size.width * 0.01075715, size.height * 0.06619785),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_0.lineTo(size.width * 0.5875000, size.height * 0.2156769);
    path_0.arcToPoint(Offset(size.width * 0.5000000, size.height * 0.7541385),
        radius:
            Radius.elliptical(size.width * 0.08750000, size.height * 0.5384615),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    path_0.lineTo(size.width * 0.4999999, size.height * 0.7541385);
    path_0.arcToPoint(Offset(size.width * 0.4125000, size.height * 0.2156769),
        radius:
            Radius.elliptical(size.width * 0.08750000, size.height * 0.5384615),
        rotation: 0,
        largeArc: false,
    ...
    path_0.arcToPoint(Offset(size.width * 0.4017575, size.height * 0.07697246),
        radius: Radius.elliptical(
            size.width * 0.01075538, size.height * 0.06618692),
        rotation: 0,
        largeArc: false,
        clockwise: false);
